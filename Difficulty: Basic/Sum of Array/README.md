<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-array2326/1?page=2&difficulty=Basic&sortBy=submissions">Sum of Array</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an integer array <strong>arr[]</strong>. The task is to find the <strong>sum </strong>of it.</span></p>
